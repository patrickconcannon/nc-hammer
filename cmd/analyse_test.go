...
func TestAnalyseCmdRun(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "single valid yaml file", testCmd: &cobra.Command{}, testArgs: []string{"../suite/testdata"}},
		//	{name: "single valid csv file", testCmd: &cobra.Command{}, testArgs: []string{"../suite/testdata"}},
		//	{name: "single invalid yaml file", testCmd: &cobra.Command{}, testArgs: []string{"../suite/testdata"}},
		//	{name: "single invalid csv file", testCmd: &cobra.Command{}, testArgs: []string{"../suite/testdata"}},
	}
